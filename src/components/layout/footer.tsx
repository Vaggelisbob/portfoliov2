    ...
    <footer className="border-t border-white/10 bg-[#1A1A1A] text-white">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-10 md:py-14 lg:py-16">
          <div className="grid gap-10 sm:gap-12 md:grid-cols-3 lg:gap-8 text-center">
            {/* Brand Section */}
            <div className="space-y-5 flex flex-col items-center">
              ...
              <div className="flex gap-4 justify-center">
                ...
                <Link href="https://www.linkedin.com/in/βαγγέλης-μπομπόνης" target="_blank" className="text-white/70 hover:text-white transition-colors">
                  <svg className="h-5 w-5" viewBox="0 0 448 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="space-y-5 flex flex-col items-center">
              ...
              <ul className="space-y-4 flex flex-col items-center">
                <li className="flex items-center gap-3">
                  ...
                  <span className="text-sm sm:text-base text-white/70">vaggelisbobonhs@gmail.com</span>
                </li>
                <li className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-white/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  <span className="text-sm sm:text-base text-white/70">(+30) 6986563740</span>
                </li>
                <li className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-white/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-sm sm:text-base text-white/70">Athens, Greece</span>
                </li>
              </ul>
            </div>
          </div>
